          ...
          <div className={card.card + " card bg-light"}>
            <div className={"position-relative " + card.card_upper}>
              ...
              <div className={card.overlay}>
                ...
                <div className={card.ico_container + " rounded-2 me-1"}>
            ...
            <div className="card-img-overlay  ">
              {product.priceAfterDiscount ? (
                <span
                  class="fa-layers     text-center fw-bold"
                  style={{ fontSize: "3rem" }}
                >
                  <i class="fa-solid fa-certificate text-danger"></i>
                  <span
                    class="fa-layers-text fa-inverse text-capitalize text-center"
            ...
            <div className="">
              <div className="card-body position-relative">
                ...
                <p className="text-black-50">
                  <span class="badge bg-warning my-1 me-1 ">
                    {" "}
